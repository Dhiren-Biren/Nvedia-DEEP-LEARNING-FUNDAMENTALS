...
def deploy(img_path):
    ...
    caffe.set_mode_gpu()
    MODEL_JOB_DIR='/dli/data/digits/20200705-013506-0df9'
    ARCH = MODEL_JOB_DIR + '/' + 'deploy.prototxt'
    WEIGHTS = MODEL_JOB_DIR + '/' + 'snapshot_iter_324.caffemodel' 
    ...
    mean_image = caffe.io.load_image('/dli/data/digits/20200705-004334-46cd/mean.jpg')
